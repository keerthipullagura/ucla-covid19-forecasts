...
#mid-dates for all states in US
...
#resurge dates for certain states
...
#method performing the validation of the model.
...
# getting the county data for the state.
def get_county_list(cc_limit=200, pop_limit=50000, data=None, County_Pop=None):
...
if __name__ == '__main__':
    ...
    if args.level == "state":
        ...
        if not args.state == "default" and not args.county == "default":
            ...
            region_list = get_county_list(cc_limit=2000, pop_limit=10, data=data, County_Pop=County_Pop)
    ...
    for region in region_list:
        ...
        if args.level == "state":
            ...
            #identifying mid dates and end dates and ranges based on input args and defined constant dates for states.
            if state in mid_dates.keys():
                second_start_date = mid_dates[state]
                # Gets a tuple of cases and deaths for a date range.
        ...
        #20% of population of region
        Ns = np.asarray([0.2])*Pop
        # array declared to take few variation while calculating the Exposed.
        ...
        # this will be 1 iteration
        for N in Ns:
            #invoked for number of entries in rs - standard initialized array for calculating E.
            for r in rs:
                E_0 = N/r
    ...
    write_file_name_all = write_dir + "val_params_" +sname+ "_END_DATE_" + args.END_DATE + "_VAL_END_DATE_" + args.VAL_END_DATE
    write_file_name_best = write_dir + "val_params_best_" +sname+ "_END_DATE_" + args.END_DATE + "_VAL_END_DATE_" + args.VAL_END_DATE
